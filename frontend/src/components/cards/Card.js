    ...
    <div>
      <div className="largeCard">
        ...
        <div className="topOfCard">
          <img className="imgBubble" src={oneUsersData.picURL} alt="user1" />
          <div className="headings">
            <p className="user">{oneUsersData.username}</p>
            <p className="date">{oneUsersData.posts.postDate}</p>
          </div>
        </div>
        <div className="post">
          <p>{oneUsersData.posts.post}</p>
        </div>
        <ReactionBar onePost={oneUsersData} />
        <CommentBar />
      </div>
    </div>
  );
