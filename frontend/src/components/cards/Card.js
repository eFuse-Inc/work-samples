      ...
      <div>
        <div className="largeCard">
          ...
          <div className="topOfCard">
            <img className="imgBubble" src={onePost.picURL} alt="user1" />
            <div className="headings">
              <p className="user">{onePost.username}</p>
              <p className="date">{onePost.date}</p>
            </div>
          </div>
          <div className="post">
            <p>{onePost.post}</p>
          </div>
          <ReactionBar onePost={onePost} />
          <CommentBar />
        </div>
      </div>
    );
